...
const AvocadoForm = ({isOpen, onClose, handleInputChange }) => {
  return (
          ...
          >
            <div className="inline-block align-bottom bg-white rounded-lg px-4   text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:w-1/3 sm:p-6">
              ...
              <input
                ...
                type="date"
                placeholder="date"
                onChange={(e) => handleInputChange("input_date", e.target.value)} // Función que se ejecuta cuando se cambia el valor del input
              />
